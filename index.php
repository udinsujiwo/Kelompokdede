...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/jiaozi.jpeg" rel="icon">
    ...
    <section id="faq" class="faq">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("assets/img/faqdimsum.jpg");'>&nbsp;</div>
        </div>
